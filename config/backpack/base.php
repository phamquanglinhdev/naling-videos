...
return [
    ...
    */
    ...
    'project_logo'   => '<b>Naling</b>video',

    // Show / hide breadcrumbs on admin panel pages.
    'breadcrumbs' => true,

    // Horizontal navbar classes. Helps make the admin panel look similar to your project's design.
    'header_class' => 'app-header bg-danger text-white border-0 navbar',
    ...
    'sidebar_class' => 'sidebar sidebar-pills bg-danger',
    ...
    'footer_class' => 'app-footer d-print-none bg-danger text-white',
    // hide it with d-none
